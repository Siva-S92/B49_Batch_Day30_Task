...
function UpdateFruit() {
  ...
  useEffect(() => {
    axios.get(`https://64f1ad5d0e1e60602d241d25.mockapi.io/tasks/${id}`).then((response) => {
  ...
  const updateFruitHandler = () => {
    ...
    axios.put(`https://64f1ad5d0e1e60602d241d25.mockapi.io/tasks/${id}`, payload).then((response) => {
        navigate("/");
    })
  };
